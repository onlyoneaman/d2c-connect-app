      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Connecting D2C brands with talented freelance designers to create exceptional products and experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/hire" className="text-gray-400 hover:text-white transition">
                  Hire Designers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/designer-guide" className="text-gray-400 hover:text-white transition">
                  Designer Guide
                </Link>
              </li>
              <li>
                <Link href="/portfolio-tips" className="text-gray-400 hover:text-white transition">
                  Portfolio Tips
                </Link>
              </li>
              <li>
                <Link href="/designer-resources" className="text-gray-400 hover:text-white transition">
                  Resources
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} D2C Connect. All rights reserved.
          </p>
